...
import { EditorObject, SignatureObject } from "@/types/pdf-editor";
    ...
    <div className="container max-w-6xl py-8">
      ...
      <div className="mt-8">
        {!file ? (
          ...
          <div className="relative">
            ...
            <div className="absolute top-4 left-1/2 -translate-x-1/2 pointer-events-none z-10">
              <div className="bg-slate-800 text-white text-sm px-4 py-2 rounded-full shadow-lg">
                Use the Signature tool in the toolbar to sign your document.
              </div>
            </div>
          </div>
        ) : (
          <ResultCard
            blob={resultBlob}
            filename={`${sanitizeFileName(file.name)}-signed.pdf`}
            onReset={reset}
          />
        )}
      </div>
